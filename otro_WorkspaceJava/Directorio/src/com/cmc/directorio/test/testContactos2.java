...
public class testContactos2 {
	...
	public static void main(String[] args) {
		Telefono t1 = new Telefono("Claro", "546541564", 20);
		Contacto c1 = new Contacto("Juana", "Pérez", t1, 50);
		
		Telefono t2 = new Telefono("Movi", "0065646465", 12);
		Contacto c2 = new Contacto("Mirella", "Chavez", t2, 38);
